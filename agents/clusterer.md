---
name: clusterer
description: brag-doc clustering agent. Dispatched only from the /brag-doc:scan command. Reads the raw JSON files (prs.json, commits.json, meta.json) and returns structured JSON that groups the contributions into meaning-based themes.
tools: Read, Bash
---
